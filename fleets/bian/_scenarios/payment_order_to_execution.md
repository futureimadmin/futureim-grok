...
- **Payment Order** stops at a validated instruction (idempotency on create).
- **Payment Execution** owns clearing/settlement and investigation queues.
- Never re-Initiate execution from retries without idempotent Execute/Retrieve checks.

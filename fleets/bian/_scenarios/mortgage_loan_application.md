...
- Emit stubs for **active** domains only for the selected rack.
- Cross-domain calls are **service operations**, not shared tables.
- Product pricing grids stay in the bank product fleet RAG context.
